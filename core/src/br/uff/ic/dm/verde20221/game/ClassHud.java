...
public class ClassHud implements InputProcessor, Disposable{
    ...
    public static ClassCommandButton btMAPS;
    public static ClassCommandButton btMAP1;
    public static ClassCommandButton btMAP2;
    public static ClassCommandButton btMAP3;
    public static ClassCommandButton btMAP4;
    public static ClassCommandButton btMAP5;
    public static ClassCommandButton btMAP6;
    ...
    public ClassHud(SpriteBatch sb, Alquimia alquimia){
        ...
        */
        ...
        TextureAtlas atlas;
        TextureAtlas mapsAtlas;
        atlas = new TextureAtlas(Gdx.files.internal("menu.pack"));
        mapsAtlas = new TextureAtlas(Gdx.files.internal("mapIcons.pack"));
        ...
        ClassHud.btPLAY  = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_PLAY, alquimia);
        tableRight.add(ClassHud.btPLAY).expandX().top().right();

        // Select map button
        tableRight.row();
        frente = mapsAtlas.createSprite("MapIcon1");
        fundo = null;
        ClassHud.btMAPS = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_MAPS, alquimia);
        tableRight.add(ClassHud.btMAPS).expandX().top().right();

//        // Map 1 button
//        tableRight.row();
//        frente = mapsAtlas.createSprite("MapIcon1");
//        fundo = null;
//        ClassHud.btMAP1  = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_MAP1);
//        tableRight.add(ClassHud.btMAP1).expandX().top().right();
//
//        // Map 2 button
//        tableRight.row();
//        frente = mapsAtlas.createSprite("MapIcon2");
//        fundo = null;
//        ClassHud.btMAP2  = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_MAP2);
//        tableRight.add(ClassHud.btMAP2).expandX().top().right();
//
//        // Map 3 button
//        tableRight.row();
//        frente = mapsAtlas.createSprite("MapIcon3");
//        fundo = null;
//        ClassHud.btMAP3  = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_MAP3);
//        tableRight.add(ClassHud.btMAP3).expandX().top().right();
//
//        // Map 4 button
//        tableRight.row();
//        frente = mapsAtlas.createSprite("MapIcon4");
//        fundo = null;
//        ClassHud.btMAP4  = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_MAP4);
//        tableRight.add(ClassHud.btMAP4).expandX().top().right();
//
//        // Map 5 button
//        tableRight.row();
//        frente = mapsAtlas.createSprite("MapIcon5");
//        fundo = null;
//        ClassHud.btMAP5  = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_MAP5);
//        tableRight.add(ClassHud.btMAP5).expandX().top().right();
//
//        // Map 6 button
//        tableRight.row();
//        frente = mapsAtlas.createSprite("MapIcon6");
//        fundo = null;
//        ClassHud.btMAP6  = new ClassCommandButton(frente, fundo, ClassCommandButton.BT_MAP6);
//        tableRight.add(ClassHud.btMAP6).expandX().top().right();
