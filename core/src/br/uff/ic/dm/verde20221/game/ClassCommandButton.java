...
import br.uff.ic.dm.verde20221.screens.MapScreen;
...
public class ClassCommandButton extends ClassActorAccessor {
    ...
    public static final int  BT_MAP1 = 8;
    public static final int  BT_MAP2 = 9;
    public static final int  BT_MAP3 = 10;
    public static final int  BT_MAP4 = 11;
    public static final int  BT_MAP5 = 12;
    public static final int  BT_MAP6 = 13;
    public static final int  BT_MAPS = 14;
    ...
    public ClassCommandButton(Sprite tfrente, Sprite tfundo, int acao, final Alquimia alquimia)  {
        super();
        frontface = true;
        previousButton = null;
        this.frente = tfrente;
            ...
            public void touchUp (InputEvent event, float x, float y, int pointer, int button) {
                ...
                if(action == ClassCommandButton.BT_RESIZE) {
                    ...
                    if(action == ClassCommandButton.BT_INTERNET_SEARCH) {
                        ...
                        // LEK */
                    } else if(action == ClassCommandButton.BT_PLAY) { // GRUPO01VERDE: Invite players
//                        ClassHud.btRESIZE.frontface = true;
//                        ClassHud.btINFO.frontface = true;
//                        ClassHud.btINTERNET.frontface = true;
//
...
//                        }
                        ...
                        ClassThreadComandos.objetoAndroidFireBase.invitePlayers();
                    } else if(action == ClassCommandButton.BT_MAPS) {
                        World.dispose();
                        alquimia.setScreen(new MapScreen(alquimia));
                    }
//                        else if(action == ClassCommandButton.BT_MAP1) {
//                            World.load("MysteryDungeon");
//                        } else if(action == ClassCommandButton.BT_MAP2) {
//                            World.load("SnowMap");
//                        } else if(action == ClassCommandButton.BT_MAP3) {
//                            World.load("Mapa1");
//                        } else if(action == ClassCommandButton.BT_MAP4) {
//                            World.load("mapa_Planoc");
//                        } else if(action == ClassCommandButton.BT_MAP5) {
//                            World.load("Mapa_Jogo");
//                        } else if(action == ClassCommandButton.BT_MAP6) {
//                            World.load("map1");
//                        }
